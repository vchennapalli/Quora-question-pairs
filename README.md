...
| Siamese LSTM + Glove + Magic features  + Normal features + Class weights + four Stacked layers| 87 | 0.18928|
...
![Kaggle Log loss](images/VineethSubmissions.png?raw=true "Test results trend")
